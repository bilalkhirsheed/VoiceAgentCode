...
export function SalesLeadsPage() {
  ...
  return (
    <div className="p-6 flex flex-col h-full space-y-4">
      <div>
        <h1 className="text-[20px] font-semibold text-crm-text">Sales Leads</h1>
      ...
      {loading && !rows.length && !error && (
        <div className="text-sm text-crm-text2">Loading sales leads…</div>
      )}
        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-2 text-left font-medium text-gray-700">Sentiment</th>
